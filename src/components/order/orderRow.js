...
import { FaUser, FaCalendar, FaDollarSign, FaEdit, FaTrash, FaChevronDown, FaChevronUp } from 'react-icons/fa';
import OrderRowData from "../../content/pageData/orderRowData"; // Importe os dados para legendas e textos

const OrderRow = (props) => {
  const [expandedOrder, setExpandedOrder] = useState(null);
  const [pageData, setPageData] = useState(OrderRowData['pt-br']);
